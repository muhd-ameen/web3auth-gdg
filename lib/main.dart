...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    Uri redirectUrl = Uri.parse('com.example.web3authdemo://openlogin');

    // if (Platform.isAndroid) {
    //   redirectUrl = Uri.parse('w3a://com.example.web3authdemo/auth');
    // } else if (Platform.isIOS) {
    //   redirectUrl = Uri.parse('com.example.web3authdemo://openlogin');
    // } else {
  ...
  Future<Web3AuthResponse> _withEmailPasswordless() {
    return Web3AuthFlutter.login(LoginParams(
        ...
        extraLoginOptions:
            ExtraLoginOptions(login_hint: "ameens.in19@gmail.com")));
  }
